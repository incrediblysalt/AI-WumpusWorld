...
public class Screen extends JPanel implements KeyListener{
	...
	private void setupInitialVariables() {
		...
		// UNCOMMENT THIS TO ADD PITS, BREEZES, WUMPUS, STENTCH, AND WALLS TO MAP
		...
		fullMap[fullMap.length-2][2].setGlitter(true);
		
		playerX = fullMap.length-3;
		playerY = 3;
		
		fullMap[fullMap.length-2][3].setWumpus(true);
		fullMap[fullMap.length-3][3].setPit(true);
		*/
		// UNCOMMENT THIS FOR HIDDEN MAP
		/*
